...
/*   Updated: 2024/07/04 14:00:30 by maugusto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	put_imgs_to_variables(t_idk *game)
{
	...
	if (!game->floor || !game->wall || !game->guy_in_wall || !game->m1
		|| !game->m2 || !game->m3 || !game->m4
		|| !game->player1 || !game->collectable || !game->exit)
		return (0);
	return (1);
}
